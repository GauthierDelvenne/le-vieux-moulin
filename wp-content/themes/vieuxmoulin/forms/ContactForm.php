...
class ContactForm
{
    ...
    public function handle(array $data): void
    {
        ...
        if (is_array($errors = $this->validate($data))) {
            ...
            $_SESSION['vieuxmoulin_contact_form_errors'] = $errors;
            $_SESSION['vieuxmoulin_contact_form_old'] = $data;
...
//            message: $this->generateMailContent($data));
        ...
        $_SESSION['vieuxmoulin_contact_form_success'] = 'Merci madame,monsieur votre message a bien été envoyé';
        wp_safe_redirect(home_url('/contact'));
        exit;
    }
